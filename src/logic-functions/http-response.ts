...
const HTTP_STATUS_BY_ERROR_CODE: Record<ApplicationErrorCode, number> = {
  ...
  COMMERCIAL_PROPOSAL_CHILD_IDENTITY_CONFLICT: 409,
  COMMERCIAL_PROPOSAL_DATA_INTEGRITY_ERROR: 500,
  ...
  CATALOG_ITEM_NOT_SELECTABLE: 409,
  CATALOG_SEARCH_FAILED: 500,
  COMMERCIAL_PROPOSAL_GENERATION_MODEL_NOT_SUPPORTED: 422,
  COMMERCIAL_PROPOSAL_GENERATION_VALIDATION_FAILED: 400,
  COMMERCIAL_PROPOSAL_GENERATION_IN_PROGRESS: 409,
  COMMERCIAL_PROPOSAL_GENERATION_OWNERSHIP_LOST: 409,
  DOCUMENT_SCHEMA_TEMPLATE_MISMATCH: 502,
  SNAPSHOT_HASH_MISMATCH: 502,
